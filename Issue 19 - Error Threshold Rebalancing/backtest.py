...
assert (strat_tot_return == 967.7822415004347)
assert (strat_mean_ann_return == 66.37364114010873)
assert (strat_std_dev.iloc[-1] == 1.811027584367656)
assert (strat_sr.iloc[-1] == 1.918333652233208)
...
assert (rolling_post_cost_sr.iloc[-1] == 1.918333652233208)

assert (strat_rolling_trading_costs_sr.iloc[-1] == 0.07308723939490136)
