...
actual_positions = df['pos_size_contracts'].resample(resample_period).last()
...
print('Trading Costs Sharpe Ratio', strat_rolling_trading_costs_sr.iloc[-1])
# print('Trading Costs based on Turnover', fees_for_turnover_contract.iloc[-1], '\n')
